# Shallow algorithms: TFIDF, Count Vectorization, Naive Bayes, XGBoost
...
# Appends list as a function to retrieve nltk part of speech tags
...
# Transforms bt_1 & bt_5 Message vectors based on functions from list_of_words
...
# Places algorithm variables in a neat tabulated format all 6 models
